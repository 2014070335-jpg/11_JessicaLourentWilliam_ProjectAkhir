...
.card{width:100%;max-width:460px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.06);backdrop-filter:blur(6px);border-radius:14px;padding:28px;box-shadow:0 12px 40px rgba(3,10,30,0.5)}
h1{margin:0;font-size:22px;text-align:center;color:#fff;margin-bottom:4px}
.lead{text-align:center;margin-bottom:18px;color:#d6e3ff}
label{display:block;font-size:13px;color:#e8f0ff;margin-bottom:4px;margin-top:10px}
input{width:100%;padding:10px 12px;border-radius:8px;border:1px solid rgba(255,255,255,0.06);background:rgba(0,0,0,0.18);color:#fff}
input:focus{border-color:var(--accent)}
.btn{width:100%;margin-top:18px;padding:12px;border-radius:10px;border:none;background:linear-gradient(90deg,var(--accent),#ffb085);color:#082033;font-weight:700;cursor:pointer}
